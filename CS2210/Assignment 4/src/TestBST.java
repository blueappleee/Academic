...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Test 2 failed1");
		}
		...
		try {
			...
			System.out.println("Test 4 failed1");
		}
		...
		try {
			...
			System.out.println("Test 5 failed1");
		}
		...
		try {
			...
			System.out.println("Test 6 failed1");
		}
		...
		try {
			...
			System.out.println("Test 7 failed1");
		}
		...
		try {
			...
			System.out.println("Test 8 failed1");
		}
		...
		try {
			...
			res = tree.get(tree.getRoot(),p);
			if (res != null) System.out.println("Test 12 failed1");
			else {
			    res = tree.get(tree.getRoot(),new Location(1,0));
			    if (res == null) System.out.println("Test 12 failed2");
			    else {
				res = tree.get(tree.getRoot(),new Location(19,10));
				if (res == null) System.out.println("Test 12 failed3");
				else System.out.println("Test 12 passed");
			    }
			}
		}
		catch (Exception e) {
			System.out.println("Test 12 failed4");
		}
		...
		try {
			...
			System.out.println("Test 14 faile1d");
		}
		...
		try {
			...
			if (res.getLocation().compareTo(new Location(39,20)) != 0)
			    ...
			    if (res == null) System.out.println("Test 16 failed1");
			    System.out.println("Test 16 passed");
			}
		}
		catch (Exception e) {
			System.out.println("Test 16 failed2");
		}

	}
	//System.out.println((res.getLocation().xCoord() + "," + res.getLocation().yCoord()));
